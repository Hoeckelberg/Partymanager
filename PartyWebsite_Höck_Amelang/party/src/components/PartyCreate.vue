...
<div class="contentgroup">
     <h3 class="head2" style="color: white; font-size: 2.5em; margin-top: 3em; margin-bottom: 2em;">Erstelle eine Party</h3> 
    <div class="lower-content">
      <form @submit="postdata">        
       ...
       <div class="input-group">
         <input type="password" placeholder="Passwort" class="textbox" v-model="Passwort" name="Passwort">
         <span class="outline"></span>
       </div>
